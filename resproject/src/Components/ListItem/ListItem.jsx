      ...
      {movies.map((item, id) => {
        return (
          <div className="w-[230px] min-h-[125px] flex-col p-[3px] cursor-pointer hover:scale-125 ease-in duration-500" >
            ...
            />
            <div class="h-[125px] w-[225px] background flex items-center text-center rounded justify-center opacity-0 hover:opacity-100 absolute top-6 overflow-hidden hover:bg-black hover:top-[3.5px] hover:bg-opacity-30 ease-in duration-500">
              {item.title}
            </div>
          </div>
        );
